const calendar = document.querySelector(".calendar"),
  ...
  addEventAtv = document.querySelector(".event-atv");
    ...
    for (let i = 1; i <= lastDate; i++) {
      ...
      eventsArr.forEach((eventObj) => {
        if (
          ...
          if (eventObj.events[0].title.toLowerCase() === "feriado") {
            className += " holiday";
          } else if (eventObj.events[0].title.toLowerCase() === "evento") {
            className += " event-day";
          }
        }
      });
...
addEventSubmit.addEventListener("click", () => {
  ...
  if (eventTitle === "" ) {
    alert("Por favor, preencha o itulo!");
    return;
  }
